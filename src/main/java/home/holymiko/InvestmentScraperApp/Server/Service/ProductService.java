...
public class ProductService {
    ...
    public List<ProductDTO_LatestPrices> findByParams(Dealer dealer, Producer producer, Metal metal, Form form, Double grams, Integer year, Boolean saveAlone) {
        return productRepository.findByParams(dealer, producer, metal, form, grams, year, saveAlone, Pageable.unpaged())
                .stream()
